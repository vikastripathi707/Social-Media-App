        ...
        <div className="col-md-5 col-sm-12">
          ...
          <div className="card shadow p-3 mb-5 bg-body rounded">
            <div className="card-body px-5 col-sm-12">
              ...
              <form>
                <div className="mb-3">
                  <input type="email" className="p-2 mb-2 mt-4 input-bg form-control" placeholder="Phone number, username  or email" />
       ...
       <div className="d-grid"><button type="submit" className="custom-btn custom-btn-blue"> Login</button>
                <div className="my-4">
                  ...
                  <div className="d-grid mt-3 mb-5">
                    <button type="submit" className="custom-btn-white custom-btn"> 
                    <span className="text-muted fs-6"> Don't have an account? </span><Link to="/signup" className="text-info ms-1 fw-bold">Sign up </Link></button> </div> 
              </form>
